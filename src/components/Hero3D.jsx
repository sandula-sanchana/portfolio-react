...
import { CONTACT_CONFIG, mailtoLink, whatsappLink } from "../utils/contactConfig.js";
...
export const Hero3D = () => {
    ...
    return (
        <section className="relative min-h-screen bg-[#0b0b0d] text-white overflow-hidden">
            ...
            <div className="hidden lg:block absolute left-[6%] top-0 h-full w-px bg-white/30" />
            <div className="hidden lg:block absolute right-[6%] top-0 h-full w-px bg-white/30" />
      ...
      "
            >
                ...
                <div className='z-50 absolute left-[5.5%] bottom-[5%] flex flex-col gap-6 pointer-events-auto'>
                    ...
                    <a href={CONTACT_CONFIG.githubUrl} target="_blank" rel="noopener noreferrer" aria-label="GitHub">
                    ...
                    <a href={mailtoLink("Let's work together")} aria-label="Email">
            ...
            >
                ...
                <h1 className="font-extrabold tracking-tight leading-[0.88] text-[clamp(2.8rem,8vw,8rem)]">
                    <BinaryText text="STRATEGIC" /> <br />
                    <BinaryText text="SOFTWARE" /> <br />
                    <BinaryText text="ENGINEER" />
                </h1>

                <p className="text-sm tracking-[0.25em] uppercase opacity-60 mb-6 max-md:text-xs">
                ...
                <div className="mt-12 flex justify-end gap-6">
                    ...
                    <Link to="/work" className="px-7 py-3 border border-white/30 rounded-md">
                        See work
                    </Link>
                </div>
            </div>
